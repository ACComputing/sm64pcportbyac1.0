...
# =======================================================================
# AC'S SM64 PC PORT — PYTHON EDITION 0.2
...
def main():
    ...
    pygame.display.set_caption("AC'S SM64 PC PORT — PY EDITION 0.2  |  (C) 2026 A.C Holdings")
            ...
            # === IN-GAME ===
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_ESCAPE:
                        ...
                        # Level transitions — F = interact/enter (SM64 A-button on doors)
